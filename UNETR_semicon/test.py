...
def main():
    def save_nifti(data,save_path):
        data_ = nib.load("/home/maoyuejingxian/UNETR_semicon/dataset/dataset0/imagesTr/06s32_void.nii.gz")
        header = data_.header
        nifti_image = nib.Nifti1Image(data,None,header)
        nib.save(nifti_image,"/home/maoyuejingxian/unetr_visualization/logic_changelossfunc_changedataagumentation_500_test/"+save_path)
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_loader):
            ...
            # print('111111111111: ', torch.max(val_inputs))
            # print('111111111111: ', torch.min(val_inputs))
            # print(torch.max(val_outputs ))
            # print(torch.min(val_outputs ))
