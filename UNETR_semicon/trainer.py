...
def train_epoch(model,
    ...
    ###add code for caculate acc_epoch
    acc_epoch = 0
...
######training accuracy######
    ...
    avg_acc_epoch = acc_epoch/43

    trainloss_acc = [run_loss.avg,avg_acc_epoch]
...
def val_epoch(model,
    ...
    with torch.no_grad():
        ...
        for idx, batch_data in enumerate(loader):
            ...
            # print('111111111111: ', torch.max(data))
            # print('111111111111: ', torch.min(data))
